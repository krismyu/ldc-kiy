...
\begin{tikzpicture}
    ...
    \draw[very thin,color=gray!50] (-0.3,-0.2) grid (17.1,17.1);
    \draw[->] (-0.3,0) -- (17.2,0) node[right] {$Shift\thinspace size$};
    \draw[->] (0,-0.3) -- (0,17.2) node[above] {$Overlap$};
    \draw[-,ultra thick] (0,0) -- (4,0);
    \draw[-,ultra thick] (4,0) -- (8,16);
    \draw[-,ultra thick] (8,16) -- (12,0);
    \draw[-,ultra thick] (12,0) -- (16,0);
...
(11,4) circle [] (12,0) circle;% \foreach \Point in {(-4,0), (-3,4), (-2,8), (-1,12), (0,16), (1,12),
%   (2,8), (3,4), (4,0)}{
