...
header_row$ = "Filename" + tab$ + "no." + tab$ + "label" + tab$ + "f0-25" + tab$ + "f0-50" + tab$ + "f0-75" +  newline$
...
select TextGrid 'object_name$'
     ...
     for b from 1 to number_of_intervals
          ...
          if interval_label$ <> ""
               ...
               t_25 = begin_vowel + duration_s/4 
               t_50 = begin_vowel + 2*duration_s/4 
               t_75 = begin_vowel + 3*duration_s/4 
           
                 
  select Pitch 'object_name$'
               f0_25 = Get value at time... 't_25' Hertz Linear
               f0_50 = Get value at time... 't_50' Hertz Linear
               f0_75 = Get value at time... 't_75' Hertz Linear
  fileappend "'directory$'f0-analysis.log" 'object_name$''tab$' 'b' 'tab$' 'interval_label$' 'tab$' 'f0_25:3' 'tab$' 'f0_50:3' 'tab$' 'f0_75:3' 'tab$' 'newline$'
